...
wineptr = Wine(name = "Duckhorn Napa Valley", year="2012", label="877453le.png", description="This Napa Valley Merlot is a complex blend of several individual vineyard lots, incorporating fruit from our Estate Vineyards and from top independent growers throughout the Napa Valley. The final wine is a rich and cohesive expression of the entire Napa Valley, reflecting the varied microclimates and soils of this unique appellation.", varietal = varietalptr)
session.add(wineptr)
session.commit()
...
wineptr = Wine(name = "Casarena Jamilla's Vineyard", year="2011", label="145292le.jpg", description="Casarena Jamilla's Vineyard Malbec is pure elegance. Rocky limestone and shallow soil terroir's best expression is this wine with mineral notes, floral and red fruit flavors. Fresh.", varietal = varietalptr)
session.add(wineptr)
session.commit()

wineptr = Wine(name = "Tangley's Oaks", year="2012", label="352689le.png", description="The 2012 Tangley Oaks Merlot is a medium garnet color. This wine offers aromas of rich plums, dark cherries, chocolate and savory herbs. On the palate, lush plums and cherry fruit with undertones of mocha.", varietal = varietalptr)
session.add(wineptr)
session.commit()
