...
wineptr = Wine(name = "Casarena Jamilla's Vineyard", year="2011", label="/static/145292le.jpg", description="Casarena Jamilla's Vineyard Malbec is pure elegance. Rocky limestone and shallow soil terroir's best expression is this wine with mineral notes, floral and red fruit flavors. Fresh.", varietal = varietalptr)
session.add(wineptr)
session.commit()

wineptr = Wine(name = "Tangley's Oaks", year="2012", label="/static/352689le.png", description="The 2012 Tangley Oaks Merlot is a medium garnet color. This wine offers aromas of rich plums, dark cherries, chocolate and savory herbs. On the palate, lush plums and cherry fruit with undertones of mocha.", varietal = varietalptr)
session.add(wineptr)
session.commit()
